...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="homepage.csstifacts/Tickets_war_exploded/homepage.css">
    ...
    <c:forEach items="${list}" var="f" varStatus="loop">
        <c:if test="${loop.index%4!=3}">
            <div class="movie-card">
                <div class="img-card">
                    <a href="checkfilm.jspifacts/Tickets_war_exploded/checkfilm.jsp?film=${f.getName()}"><img src="${f.getImgpath()}"></a>
                </div>
                ...
                <div class="card-hover" id="crdhvr">
                    ...
                    <div class="info-card">
                        ...
                        <a href="checkfilm.jspifacts/Tickets_war_exploded/checkfilm.jsp?film=${f.getName()}">ვრცლად</a>
                    </div>
                </div>
            </div>
        </c:if>
