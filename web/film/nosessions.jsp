        ...
        <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="homepage.jsptifacts/Tickets_war_exploded/homepage.jsp">Tickets</a>
                </li>
            </ul>
        </div>
        <div class="mx-auto order-0" id="homepage">
            <a class="navbar-brand mx-auto" href="homepage.jsptifacts/Tickets_war_exploded/homepage.jsp">Home page</a>
