...
<main>
    ...
    <aside id="left-aside">
        ...
        <form method="post" action="checkedit.jsp" id="edit-form" class="justify-content-center">
    ...
    <aside id="right-aside">
        ...
        <div id="cards">
            <c:forEach items="${cards}" var="c" >
                ...
                <div class="editcenter hideeditform" id="card-edit-div${c.getCard_id()}">
                    ...
                    <form method="post" action="checkcardedit.jsp"  class="justify-content-center editcard-form">
        ...
        <div class="center hideform">
            ...
            <form method="post" action="checkaddcard.jsp" id="addcard-form" class="justify-content-center">
